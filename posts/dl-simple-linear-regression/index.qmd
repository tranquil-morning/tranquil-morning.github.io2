...
library(tidyverse)
example <- tibble(hours = c(10,9,3,2), score = c(90,80,50,30))
example
```

```{r plot1, message = FALSE, warning = FALSE, echo = FALSE}
example |> ggplot(aes(x = hours, y = score)) + geom_point() + geom_smooth(method = "lm", se = FALSE)
```
