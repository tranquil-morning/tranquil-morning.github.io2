...
[출처] [Random Forest Simple Explanation | by Will Koehrsen | Medium](https://williamkoehrsen.medium.com/random-forest-simple-explanation-377895a60d2d)
...
![](dataset.png)
[출처] : [Fashion MNIST | Kaggle](https://www.kaggle.com/datasets/zalando-research/fashionmnist)
