...
하지만 두 차트의 인상은 확연히 다릅니다. 색상, 텍스트 주석, 글꼴 크기, 레이블과 같은 추가 정보가 오른쪽 차트를 훨씬 더 쉽게 해석할 수 있도록 만들어 줍니다. 이 섹션에서는 이러한 각 요소를 살펴보고 차트의 접근성과 해석도를 개선하기 위한 스타일 지정법을 알아보겠습니다.
...
library(cowplot) 
plot_grid(gg_unst,gg_st, rel_widths = c(2, 2))
```
